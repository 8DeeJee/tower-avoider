...
import com.circleEnyx.entities.Particle;
...
//	}
	...
	public static void generateParticles(int ammount, int x, int y, Color color, int lifetime) {
		for(int i = 0; i < ammount; i++) {
			Game.entities.add(new Particle(x, y, 2, 2, 0, null, color));
		}
	}
